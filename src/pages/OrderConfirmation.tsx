    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-muted-foreground leading-relaxed mb-6 max-w-md mx-auto">
          Ваше замовлення прийнято. Ми зв'яжемося з вами найближчим часом для підтвердження деталей та відправки.
        </p>

        <p className="text-muted-foreground leading-relaxed mb-8 max-w-md mx-auto">
          Кожен виріб Shepit Ceramics — це ручна робота, тому ми подбаємо, щоб ваша прикраса була ідеально упакована та доставлена з любов'ю 🤍
        </p>
